...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS=' ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr --with-mpi=open_mpi --disable-aio"
...
#define MCA_timer_IMPLEMENTATION_HEADER "opal/mca/timer/base/timer_base_null.h"
...
#define OMPI_ARCH "mipsel-unknown-linux-gnu"
...
#define OMPI_ASSEMBLY_ARCH OMPI_MIPS

/* Format of assembly file */
#define OMPI_ASSEMBLY_FORMAT "default-.text-.globl-:--.L-@-1-1-1-0-0"
...
#define OPAL_PACKAGE_STRING "Open MPI yj2244@debian-ovp Distribution"
...
#define PAFFINITY_LINUX_PLPA_VERSION "1.3.2"
...
#define WRAPPER_EXTRA_LIBS "  -ldl   -Wl,--export-dynamic -lnsl -lutil -lm -ldl "
